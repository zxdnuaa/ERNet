...
def test_metrics():
    ...
    # Test the availability of arg: ignore_index.测试参数的可用性：ignore_index
    label[:, 2, 5:10] = ignore_index

    # Test the correctness of the implementation of mIoU calculation.测试mIoU计算实现的正确性
    ...
    # Test the correctness of the implementation of mDice calculation.测试mDice计算实现的正确性
    ret_metrics = eval_metrics(
    ...
    # Test the correctness of the implementation of mDice calculation.测试mdevice计算实现的正确性。
    ret_metrics = eval_metrics(
    ...
    # Test the correctness of the implementation of joint calculation.检验联合计算实现的正确性。
    ret_metrics = eval_metrics(
        results,
        label,
        num_classes,
    ...
    # than the maximum value of input maps.当arg: num_classes大于输入映射的最大值时，测试计算的正确性。

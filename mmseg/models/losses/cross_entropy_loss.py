...
class CrossEntropyLoss(nn.Module):
    ...
    def forward(self,
        ...
        """Forward function."""
        '''
        cls_score= torch.Size([1, 19, 512, 1024]) label= torch.Size([1, 512, 1024])
cls_score= torch.Size([1, 2, 512, 1024]) label= torch.Size([1, 512, 1024])
        '''
        # print("cls_score=",cls_score.size(),"label=",label.size())
